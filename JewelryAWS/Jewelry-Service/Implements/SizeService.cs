...
{
    public SizeService(IUnitOfWork<JewelryAwsContext> unitOfWork, ILogger<SizeService> logger, IHttpContextAccessor httpContextAccessor) : base(unitOfWork, logger, httpContextAccessor)
    {
    }
